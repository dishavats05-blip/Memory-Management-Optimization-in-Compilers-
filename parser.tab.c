...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "PLUS", "MINUS", "MUL", "DIV", "SEMI", "LPAREN", "RPAREN",
...
{
      10,    11,    16,    17,    18,    19,    15,     6,    21,    12,
      22,    23,    24,    25,    16,    17,    18,    19,    20,    16,
      17,    18,    19,     1,     7,     2,     8,    14,     9
};

static const yytype_int8 yycheck[] =
{
       3,     4,     7,     8,     9,    10,    12,     6,    13,    12,
      16,    17,    18,    19,     7,     8,     9,    10,    11,     7,
       8,     9,    10,     3,     3,     5,     0,    11,     4
};
...
{
       0,     3,     5,    15,    16,    17,     6,     3,     0,    17,
       3,     4,    12,    18,    11,    18,     7,     8,     9,    10,
      11,    13,    18,    18,    18,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* stmt: INT ID SEMI  */
#line 36 "parser.y"
                {
        // 🔹 Declaration Phase
        allocateVariable((yyvsp[-1].str));
        declareVar((yyvsp[-1].str));
    }
#line 1096 "parser.tab.c"
    break;

  case 6: /* stmt: ID ASSIGN expr SEMI  */
#line 42 "parser.y"
                        {
        // 🔹 Semantic Check
        checkVariable((yyvsp[-3].str));

        // 🔹 TAC Generation
        generateTAC("=", (yyvsp[-1].str), "", (yyvsp[-3].str));
    }
...
#line 52 "parser.y"
        ...
        generateTAC("+", (yyvsp[-2].str), (yyvsp[0].str), temp);
