...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "PLUS", "MUL", "SEMI", "$accept", "program", "stmt_list",
...
{
       0,     3,     5,    11,    12,    13,     6,     3,     0,    13,
       3,     4,    14,     9,     7,     8,     9,    14,    14
};
